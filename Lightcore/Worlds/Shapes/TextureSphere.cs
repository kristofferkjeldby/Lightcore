namespace Lightcore.Worlds
{
    ...
    {
        public static Entity TextureSphere(Vector color, Vector origon, float radius, int segments, ImageTextureBuilder textureBuilder, RenderMode renderMode = null)
        {
            ...
            textureBuilder.Slice(segments, segments, ImageTextureBuilderStartPosition.TopLeft);
            ...
            for (int t = 0; t < segments; t++)
            {
                ...
                for (int p = 0; p < segments; p++)
                {
                    ...
                    (
                        new Polygon
                        (
                            textureBuilder.GetTexture(color, p, t),
                            new Vector[]
                            {
                                vector10,
                                vector11,
